...
const NavBar = () => {
    ...
    return (
        <div>
            <nav className="w-full flex justify-between navbar text-xl font-accent text-black">
                <div className="flex items-center justify-center">
                    <a className="relative rounded [animation-delay:1.5s] before:absolute before:border-black before:left-0 before:top-0 before:h-full before:w-full before:border-b before:border-text before:transition-all before:content-[''] hover:before:scale-x-100 active:before:scale-x-100 md:before:scale-x-0 md:before:border-b-2">
                        home
                    </a>
                </div>
